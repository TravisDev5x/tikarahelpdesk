...
| `docs/INVENTORY_ROADMAP.md` | Bitácora de fases del port de Inventario (HelpdeskECD2026 → Tikara) — qué está cerrado y qué falta (exports, vista de asignación, permisos granulares) |
