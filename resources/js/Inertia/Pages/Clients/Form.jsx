    ...
    return (
        <AuthenticatedLayout title={title}>
            ...
            <form
                onSubmit={submit}
                onKeyDown={(e) => {
                    // Página con muchos campos en un solo <form> -- Enter en
                    // cualquier input dispara submit nativo del navegador.
                    // El campo de dirección (AddressMapField) ya maneja su
                    // propio Enter (busca en el mapa); en todo lo demás lo
                    // bloqueamos para evitar un guardado accidental a medio
                    // llenar.
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0">
                        <div>
                            ...
                            <CardDescription>Opcional -- puedes agregarlas ahora o después desde este mismo formulario.</CardDescription>
                        </div>
